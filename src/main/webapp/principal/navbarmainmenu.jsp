<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <nav class="pcoded-navbar">
                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          ...
                          <ul class="pcoded-item pcoded-left-item" style="margin-top: 15px">
                              <li class="active">
    ...
    <!--************************ MENU USUÁRIO ***********************************************-->
                                  ...
                                  <c:if test="${perfil == 'ADMIN'}">
                                  	...
                                  	<li class=" ">
                                          <a href="<%=request.getContextPath() %>/ServletUsuControler?acao=listarUser" class="waves-effect waves-dark">
                                    ...
                                    <!--  
                                      <li class=" ">
                                          <a href="<%=request.getContextPath() %>/ServletUsuControler?acao=novoCad" class="waves-effect waves-dark">
                                              <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                              <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Novo Cadastro</span>
                                              <span class="pcoded-mcaret"></span>
                                          </a>
                                      </li>
                                      <li class=" ">
